...
__all__ = ['scrypt_encrypt_file_key',
           'scrypt_decrypt_file_key', 'SCRYPT_RECIPIENT_LABEL']

SCRYPT_RECIPIENT_LABEL = "scrypt"


def scrypt_encrypt_file_key(password: bytes, file_key: bytes) \
...
def scrypt_decrypt_file_key(password: bytes, salt: str, cost: str,
                            encrypted: str) -> bytes:
