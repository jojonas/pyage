...
from age.primitives import rsa_encrypt, rsa_decrypt, sha256
...
def ssh_rsa_decrypt_file_key(
    ...
    expected_fingerprint = sha256(private_key.public_key().binary_encoding())[
        :4
    ]
