...
__all__ = ['x25519_encrypt_file_key',
           'x25519_decrypt_file_key', 'X25519_RECIPIENT_LABEL']

X25519_RECIPIENT_LABEL = "X25519"
AGE_X25519_HKDF_LABEL = b"age-tool.com X25519"


def x25519_encrypt_file_key(public_key: AgePublicKey, file_key: bytes) \
...
def x25519_decrypt_file_key(private_key: AgePrivateKey,
                            derived_secret: str, encrypted: str):
