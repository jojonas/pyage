...
def test_vector1():
    ...
    input_scalar = bytes.fromhex("a546e36bf0527c9d3b16154b82465edd62144c0ac1fc5a18506a2244ba449ac4")
...
def test_vector2():
    ...
    input_scalar = bytes.fromhex("4b66e9d4d1b4673c5ad22691957d6af5c11b6421e0ea01d42ca4169e7918ba0d")
    input_u_coordinate = bytes.fromhex(
